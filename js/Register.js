...
// 目的刷新时显示省份信息
for(var key in provinceArr){//key 数组下标
...
function showCity(currrent, child, childArr){
	var curentValue = currrent.value;  /*城市*/
	var count = childArr.length;
	child.length = 1;
	for(var i = 0;i < count; i++){
		if(curentValue==childArr[i][0]){
...
province.onchange = function(){
	showCity(province,city,cityArr);
}
